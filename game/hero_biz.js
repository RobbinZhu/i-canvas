...
hero.width = hero.height = 100
    // hero.position.update(4526, 1400)
hero.position.update(100, 100)
...
hero.onUpdate.push(function(session, camera) {
    ...
    this.handleCollision(this.collideLayer, session, camera)
    this.position.add(this.velocityCorrection)
...
hero.afterUpdate.push(function(session, camera) {
    const deltaX = camera.position.x - this.position.x
    const deltaY = camera.position.y - this.position.y
